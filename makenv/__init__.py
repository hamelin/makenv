...
def parse_args():
    parser = ArgumentParser(description="Set up a data science environment.")
    parser.add_argument(
        "display_name",
    ...
    parser.add_argument(
        ...
        "--directory",
        default="./.conda-env",
        help="Directory where to set up the environment."
    )
    parser.add_argument(
        "-F",
        "--fallback",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="No command line interactivity, answer `yes' to all questions."
    )
